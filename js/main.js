...
function spin_audio(){
  document.getElementById('spin_audio').currentTime = 0;
  document.getElementById('spin_audio').play();
}

function stop_audio(){
  document.getElementById('stop_audio').currentTime = 0;
...

{
    ...
    bonusTimeKoyaku() {
      if(this.reelno === 1){
        if (this.koyakuId === 0) { //オレンジ
          ...
          this.img3.src = this.reel[0];
        } else if (this.koyakuId === 2) { //replay
  ...
  function chancetenmetsu() {
    if (chance.classList.contains('chance_off_inactive')) {
      ...
      document.getElementById('atari_audio').play();
  ...
  function bigtento() {
    if (biglamptimeoutId !== undefined) {
      ...
      document.getElementById('auatari_audio').play();
  ...
  function reelChk() {
    ...
    if (reelSoroiPtn === 1 && panel_1.img2.src.split('/').reverse()[0] === 'room.png') {
      reelSoroiPtn = 6;
    }
  ...
  function coinGet(ptn,zugara) {
    ...
    if (ptn === 6 && bonusTimeOn === 0) {
      coinHyojiCnt = coinHyojiCnt + 5;
    }
    if (ptn === 6) {
      zugara = 'room.png';
    }
    ...
    switch (zugara) {
      case 'orange.png':
        coinHyojiCnt = coinHyojiCnt + 3;
        break;
      case 'bell.png':
        coinHyojiCnt = coinHyojiCnt + 4;
        break;
      case 'suika.png':
        coinHyojiCnt = coinHyojiCnt + 5;
        break;
      case 'sakuranbo.png':
        coinHyojiCnt = coinHyojiCnt + 7;
        break;
      case 'room.png':
        coinHyojiCnt = coinHyojiCnt + 10;
        break;
      case 'akuma.png':
        coinHyojiCnt = coinHyojiCnt - 3;
        break;
